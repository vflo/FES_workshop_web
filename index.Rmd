...
```{r , echo=FALSE,  out.width = '25%',fig.pos="hbt!", fig.align="center",out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(dpi = 150, path = "images/ilse.jpg")
```
<p><b>Ilse Geijzendorffer (ILSE)</b>, Louis Bolk Institute, Netherlands ([0000-0002-8471-7695](https://orcid.org/0000-0002-8471-7695))</p>
...
```{r , echo=FALSE,  out.width = '25%',fig.pos="hbt!", fig.align="center",out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(dpi = 150, path = "images/Tord.jpg")
```
<p><b>Tord Snäll (TS)</b>, SLU Swedish Species Information Centre, Swedish University of Agricultural Sciences, Sweden ([0000-0001-5856-5539](https://orcid.org/0000-0001-5856-5539))</p>
My group works on increasing the understanding of how environmental conditions affect levels and dynamics of ecosystem services on different spatial scales. We mostly answer these questions by statistical modelling of field data, typically large-scale monitoring data such as from the national forest inventory. Another main research interest is how these ecosystem services may be affected by scenarios of future forestry or climate change. This includes simulating scenarios (answering What if?) and optimization (answering How?). The main spatial scales studied are the landscape and national scales, but we also consider the EU and global scales. This work on the management of ecosystem services is based on a general interest in the ecology, use and conservation of forests and their biodiversity. I am a professor of ecology at the SLU Swedish Species Information Centre, Swedish University of Agricultural Sciences (SLU).
...
```{r , echo=FALSE,  out.width = '25%',fig.pos="hbt!", fig.align="center",out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(dpi = 150, path = "images/francesco.jpg")
```
<p><b>Francesco D'Adamo (FDA)</b>, CREAF/UAB, Spain ([0000-0003-4428-0713](https://orcid.org/0000-0003-4428-0713))</p>
I am a physical geographer (UCL, 2015) and PhD in remote sensing (University of Southampton, 2020). After a postdoc at the University of Southampton, I am now working as a postdoc at CREAF. Here, I joined a European project (RESONATE) aimed at assessing/modelling forest ecosystem services resilience across different forested regions in Europe. Overall, I am interested in process-based modelling, forest ecology, remote sensing applications for vegetation monitoring, and spatial ecology.
...
```{r , echo=FALSE,  out.width = '25%',fig.pos="hbt!", fig.align="center",out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(dpi = 150, path = "images/Maurizio.jpg")
```
<p><b>Maurizio Mencuccini (MM)</b>, CREAF/ICREA, Spain/ University of Edinburgh, UK  ([0000-0003-0840-1477](https://orcid.org/0000-0003-0840-1477))</p>
...
```{r , echo=FALSE,  out.width = '25%',fig.pos="hbt!", fig.align="center",out.extra='style="float:left; padding:10px"'}
knitr::include_graphics(dpi = 150, path = "images/albert.png")
```
...
<h3>Support volunteers:</h3>


<p><b>Brenda Verónica Fatecha</b>, ([0000-0001-9142-9854](https://orcid.org/0000-0001-9142-9854))</p>


<p><b>Pablo Sánchez Martínez</b>,   ([0000-0002-0157-7800](https://orcid.org/0000-0002-0157-7800))</p>


<p><b>Susana Silvestre Carbonell</b>, ([0000-0002-0061-8113](https://orcid.org/0000-0002-0061-8113))</p>

<p><b>Luca da Sois</b>, ([0000-0002-1170-7410](https://orcid.org/0000-0002-1170-7410))</p>
...
<br>
```{r group, echo=FALSE,  out.width = '80%',fig.pos="hbt!", fig.align="center"}
knitr::include_graphics(dpi = 150, path = "images/group.jpg")
```

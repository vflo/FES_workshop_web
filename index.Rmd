...
<p style="text-align:left;>Kim Novick (KN), Indiana University,USA</p> 

<p style="text-align:left;>Rosie Fisher (RF), Univ. Paul Sabatier III. Toulouse, France. (Remote)</p> 

<p style="text-align:left;>Lucy Rowland (LR), University of Exeter, UK (Remote)</p>

<p style="text-align:left;>Alexandra Konings (AK), Stanford University, USA</p> 

<p style="text-align:left;>Diego Miralles (DM), Ghent University, Belgium</p> 

<p style="text-align:left;>Jacob Nelson (JN), Max-Planck Institute for Biogeochemistry Jena, Germany</p>

<p style="text-align:left;>Weijie Zhang (WZ), Max-Planck Institute for Biogeochemistry Jena, Germany</p>

<p style="text-align:left;>Mirco Migliavacca (MiM), European Commission, Joint Research Centre (JRC), Ispra, Italy (Remote)</p>  

<p style="text-align:left;>Paulo Bittencourt (PB), University of Exeter, UK</p> 

<p style="text-align:left;>Bill Anderegg (BA), University of Utah, USA</p> 

<p style="text-align:left;>Josep Peñuelas (JP), CREAF, Spain</p> 

<p style="text-align:left;>Maurizio Mencuccini (MM), CREAF, Spain</p>
...
<p style="text-align:left;>Rafael Poyatos (RP), CREAF</p>

<p style="text-align:left;>Víctor Flo (VF), CREAF</p>

<p style="text-align:left;>Víctor Granda (VG), CREAF</p>

<p style="text-align:left;>Jordi Martínez-Vilalta (JMV), CREAF/Professor UAB</p>

<p style="text-align:left;>Miquel de Cáceres (MC), CREAF</p>

<p style="text-align:left;>Brenda Fatecha (BF), CREAF</p>

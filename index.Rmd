...
<br>
<br>
<p style= "font-size:calc(14px + 1.5vw)">Why, What, Where, When and How to compare ecosystem services</p>
</center>
<br>
...
<b>Why should we compare FES?</b> To highlight the main reasons for (or against) the comparisons on the delivery of ES. We will identify relevant cases where comparing ES should be (or not) recommended. Including, among others: research aims, management purposes, conservation priorities, etc. Here we will include general aspects such as the need to assess multiple values, but also the importance of developing detailed assessments of the health of these ecosystems for human well being.
...
* <b>What:</b> To identify and enumerate which FES and which of their components are sensitive to vary across contexts: ecological/potential supply, etc. Also, we will review the most frequently used indicators and proxies to quantify ES and those which can be applied to forests. ES relationships (i.e. synergies or trade-offs, bundles), or comparisons for single ES vs. multidimensionality/trade-offs and their relevance can be also discussed here . Finally, we will describe potential methodologies to transform or normalise ES values to make them comparable. Thus, we will review currently existing methods to compare ES and will develop new approaches to standardise ES depending on ES types and discussed contexts. 

* <b>Where:</b> To deal with the socio-ecological context. Forests provide a wide range of benefits to the people. However, these benefits are dependent on the socio/geographical/spatial context. Thus,  to determine different levels of variation relevant for the comparison of ES is key. We will assess spatial ES variation from macro-scale (ie. biogeographical context and over-country level) to local scale (landscape heterogeneity and city administrative demarcations).

* <b>When:</b> To deal with the temporal context. To identify the role of the temporal trends and resolution in ES comparison. ES delivery is not constant and these benefits may show temporal changes. Thus, we will determine the different mesurables periods and the type of data sources that can be useful to perform comparisons of ES taking into account the temporal scale. 
...
<p><b>Jose Valentin Roces-Diaz (JR)</b>, ([0000-0003-2569-8049](https://orcid.org/ 0000-0003-2569-8049))</p>
...
<p><b>Judit Lecina (JL)</b>, ([0000-0002-6867-5886](https://orcid.org/ 0000-0002-6867-5886))</p>
...
<p><b>Maria Angeles Perez-Navarro (MAPN)</b>, ([0000-0001-5553-995X](https://orcid.org/ 0000-0001-5553-995X))</p>
...
<p><b>Luciana Jaime (LJ)</b>, ([0000-0002-2452-6790](https://orcid.org/ 0000-0002-2452-6790))</p>
...
<p><b>Albert Vila (AV)</b>,  ([0000-0001-7589-7797](https://orcid.org/ 0000-0001-7589-7797))</p>
...
<p><b>Victor Flo (VF)</b>, ([0000-0003-1908-4577](https://orcid.org/ 0000-0003-1908-4577))</p>
I am a Biosystems Engineer (Polytechnic University of Catalonia ,  2013) and obtained a PhD in ecology  from the Autonomous University of Barcelona (UAB, 2021). I am currently a Postdoctoral researcher at the Imperial College of London. My research focuses on Land-Surface modelling, particularly on hydrological processes. I am interested in plant water and carbon economy and how it influences forest functioning, land-atmosphere interactions and the provision of ecosystem services in a context of global change.
